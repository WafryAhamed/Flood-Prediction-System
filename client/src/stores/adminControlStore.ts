  ...
  dashboardResources: [
    {
      ...
      detail: 'Equipped with emergency medical staff and pharmaceutical supplies',
    },
    {
      id: 'dr-2',
      ...
      detail: 'Housing 3,500+ evacuees with food and water',
    },
    {
      id: 'dr-3',
      ...
      quantity: 8,
      status: 'DEPLOYED',
      location: 'Gampaha, Batticaloa',
      detail: 'Producing 50,000+ liters of clean water daily',
    },
    {
      id: 'dr-4',
      ...
      detail: 'Excavators, trucks for debris clearance and drainage',
    },
    {
      id: 'dr-5',
      ...
      detail: 'Swift water rescue teams ready for deployment',
    },
    {
      id: 'dr-6',
      ...
      detail: '2-week emergency food rations per family',
    },
    {
      id: 'dr-7',
      ...
      status: 'DISTRIBUTED',
      location: 'Shelters',
      detail: 'Cold weather items and spare clothing sets',
    },
    {
      id: 'dr-8',
      ...
      quantity: 15,
      status: 'DEPLOYED',
      location: 'Shelters & Hospitals',
      detail: 'Providing backup power to critical facilities',
    },
  ],
