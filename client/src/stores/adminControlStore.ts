...
export const useAdminControlStore = create<AdminControlStore>((set, get) => ({
  ...
  agricultureZones: [
    ...
    },
    {
      ...
      label: 'High Risk',
      riskLevel: 'CRITICAL' as const,
      district: 'Jaffna District, Northern',
      details: 'Lagoon water levels critically high. 3,200 hectares of agricultural land at severe risk. Immediate action required.',
      accentColor: 'critical' as const,
    },
    {
      id: 'az-8',
      label: 'Moderate Risk',
      riskLevel: 'HIGH' as const,
      district: 'Mullaitivu District, Eastern',
      details: 'Seasonal farming areas affected by saltwater intrusion. Freshwater wells contaminated. 2,100 families impacted.',
      accentColor: 'high' as const,
    },
    {
      id: 'az-9',
      label: 'Caution',
      riskLevel: 'MODERATE' as const,
      district: 'Ampara District, Eastern',
      details: 'Mixed farming zones showing stable conditions. Early warning systems active. Crop monitoring in progress.',
      accentColor: 'warning' as const,
    },
  ],
