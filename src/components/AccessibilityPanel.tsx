...
export function AccessibilityPanel() {
  ...
  return <>
    <button onClick={() => setIsOpen(true)} className="fixed right-6 bottom-68 z-[9999] pointer-events-auto bg-[#0066FF] text-white w-14 h-14 flex items-center justify-center rounded-full shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:scale-105 active:scale-95 transition-transform border-4 border-white" aria-label="Open Accessibility Settings">
